...
function sticky_element_footer() {
  ...
  $padding = get_option('sticky_element_padding');
...
function register_mysettings() {
	...
	register_setting( 'sticky-element-settings-group', 'sticky_element_padding', 'validate_number' );
}
...
<form method="post" action="options.php">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
        <th scope="row">Top Offset - to hold sticky element off top of page</th>
        <td><input type="text" name="sticky_element_padding" value="<?php echo get_option('sticky_element_padding'); ?>" placeholder="e.g. 80" />px</td>
        </tr>
    </table>
